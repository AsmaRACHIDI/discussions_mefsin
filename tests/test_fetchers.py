...
def test_fetch_discussions_data_gouv(fetcher_data_gouv):
    ...
    assert all(
        "discussion_id" in discussion for discussion in discussions
    ), "Each discussion should have a discussion_id"
...
def test_format_datasets_data_gouv(unformatted_datasets_data_gouv, formatted_datasets_data_gouv):
    ...
    assert (
        formatted_datasets == formatted_datasets_data_gouv
    ), f"Expected {formatted_datasets_data_gouv}, but got {formatted_datasets}"
...
def test_format_discussions_data_gouv(unformatted_discussions_data_gouv, formatted_discussions_data_gouv):
    ...
    assert (
        formatted_discussions == formatted_discussions_data_gouv
    ), f"Expected {formatted_discussions_data_gouv}, but got {formatted_discussions}"
...
def test_format_datasets_data_eco(unformatted_datasets_data_eco, formatted_datasets_data_eco):
    ...
    assert (
        formatted_datasets == formatted_datasets_data_eco
    ), f"Expected {formatted_datasets_data_eco}, but got {formatted_datasets}"
...
def test_format_discussions_data_eco(unformatted_discussions_data_eco, formatted_discussions_data_eco):
    ...
    assert (
        formatted_discussions == formatted_discussions_data_eco
    ), f"Expected {formatted_discussions_data_eco}, but got {formatted_discussions}"
